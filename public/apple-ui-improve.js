window.addEventListener('DOMContentLoaded', () => {
  ...
  style.textContent = `
    ...
    @media(max-width:820px){
      ...
      .apple-result-card td:nth-child(5){grid-area:meta!important;justify-self:end!important;margin-top:14px!important;padding-top:12px!important;color:#77787d!important;font-size:12px!important;line-height:1.4!important;white-space:nowrap!important;max-width:42%!important;overflow:hidden!important;text-overflow:ellipsis!important}
      .apple-result-card td:nth-child(5)::before{display:inline!important;content:'規格  '!important;color:#9a9aa0!important;font-weight:700!important}

      .apple-result-card td:nth-child(3){grid-area:lang!important;margin-top:12px!important;padding:10px 12px!important;border-radius:14px!important;background:#f6f7f9!important;color:#696970!important;font-size:12px!important;line-height:1.5!important}
      .apple-result-card td:nth-child(3):has(.muted:first-child:last-child){display:none!important}
      .apple-result-card td:nth-child(3) br{display:none!important}
      .apple-result-card td:nth-child(3) .muted{display:block!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
      .apple-result-card td:nth-child(3) .muted + .muted{margin-top:2px!important}
