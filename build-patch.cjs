...
function patchFile(file) {
  ...
  if (file === 'index.html') {
    ...
    text = text.replace('</body>', '<script src="/barcode-scan-fix.js?v=stable-20260701j"></script><script src="/modal-ui-patch.js?v=stable-20260701j"></script><script src="/cloud-sync-patch.js?v=stable-20260701j"></script></body>');
  }
